...
def train_regression(args):
    ...
    for epoch in range(args.epochs):
        ...
        # Validation Phase
        # ====================================================================
        val_err, val_r2, val_loss, val_targets, val_preds = evaluate(
            model,
            norm_factor,
            val_loader,
            device,
        ...
        if best_flag:
            ...
            if args.tvt:
                test_err, test_r2, test_loss, _, _ = evaluate(
                    model,
                    norm_factor,
                    test_loader,
                    device,
        ...
        if model_ema is not None:
            ema_val_err, ema_val_r2, _, _, _ = evaluate(
                model_ema.module,
                norm_factor,
                val_loader,
                device,
            ...
            if ema_val_err < best_ema_val_err:
                ...
                if args.tvt:
                    test_ema_err, test_ema_r2, _, _, _ = evaluate(
                        model_ema.module,
                        norm_factor,
                        test_loader,
                        device,
